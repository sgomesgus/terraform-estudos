...
Repositório dedicado ao aprendizado prático e anotações teóricas sobre **Terraform (Infrastructure as Code - IaC)**.
...
```text
.
├── labs/                             # Laboratórios práticos com código Terraform
│   ├── 01-hcl-basics/                # Sintaxe básica HCL e recurso local_file
...
## 📚 Tópicos e Notas de Estudo

- 📄 [Terraform - Conceitos Básicos](notes/Terraform%20-%20Conceitos%20Básicos.md)
- 📄 [Lab 01: HCL Basics & Recursos Básicos](notes/01-hcl-basics.md)
- 📄 [Lab 02: Providers & Múltiplos Recursos](notes/02-providers.md)
